...
class Animator {
     ...
     * @param {boolean} flip            If sprite should be flipped (sprites face right on sheet), false by default
     * @param {boolean} loop            If the animation should loop, false by default
     * @param {number} fps              Frames per second, 60 by default
     * @return {Animator}              This Animation object.
     */
    constructor(spriteSheet, width, height, frameCount,
                startFrameX = 0, startFrameY = 0,
                flip = false, loop = false, fps = 60) {
        Object.assign(this, { spriteSheet, width, height, frameCount, startFrameX, startFrameY, flip, loop });
